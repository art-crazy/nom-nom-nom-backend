...
export class RecipeController {
  ...
  @ApiQuery({ name: 'dish_categories', required: false, type: String, description: 'Comma-separated dish category IDs' })
  @ApiQuery({ name: 'subcategories', required: false, type: String, description: 'Comma-separated subcategory IDs' })
  @ApiQuery({ name: 'cuisine_categories', required: false, type: String, description: 'Comma-separated cuisine category IDs' })
  @ApiQuery({ name: 'diet_categories', required: false, type: String, description: 'Comma-separated diet category IDs' })
  async findAll(
